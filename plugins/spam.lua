    ...
    if msgs > max_msg then 
     ...
     if msg.to.type == 'chat' or msg.to.type == 'channel' then 
      if username then 
         ...
         send_large_msg(receiver , " عہزيہزيہ مہمہنہؤعہ ❌ آلتہكہرآر فہيہ هہذهہ آلمہجہمہؤعہهہ 🌐 تہمہ طہردكہ 🗣 بہسہبہبہ عہدمہ آلآلتہزآمہ بہهہذآ آلآمہر♥️❗️ \n\n♥️ مہعہرفہكہ : @"..username.."\n\n ❤️ آيہديہكہ : "..msg.from.id.."\n\n مہطہؤر آلسہؤرسہ\n  @llX8Xll")
      else 
